...
<section id="about" class="about section-show">
    ...
    <form name="editCourse" method="post" action='<c:url value="/resume/${person.personId}/edit/course/${course.courseId}/edit"/>'>
        ...
        <div class="content" data-aos="fade-left">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="name" id="courseName" value="${course.name}" placeholder="Enter course name">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="organization" id="company" value="${course.organization}" placeholder="Enter organization name">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="timeRange" id="timeRange" value="${course.timeRange}" placeholder="Enter time range">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <textarea class="form-ctrl" name="description" id="description" rows="5" placeholder="Describe the course">${course.description}</textarea>
                </div>
            </div>
