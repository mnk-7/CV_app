...
<section id="about" class="about section-show">
    ...
    <form name="addEducation" method="post" action='<c:url value="/resume/${person.personId}/edit/edu/add"/>'>
        ...
        <div class="content" data-aos="fade-left">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="fieldOfStudy" id="fieldOfStudy" placeholder="Enter field of study">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="university" id="university" placeholder="Enter university name">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <textarea class="form-ctrl" name="description" id="description" rows="5" placeholder="Describe your studies"></textarea>
                </div>
            </div>
