...
<section id="about" class="about section-show">
    ...
    <form name="addVolunteerWork" method="post" action='<c:url value="/resume/${person.personId}/edit/volunteer/add"/>'>
        ...
        <div class="content" data-aos="fade-left">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="position" id="position" placeholder="Enter volunteer position">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <textarea class="form-ctrl" name="description" id="description" rows="5" placeholder="Describe your activities"></textarea>
                </div>
            </div>
