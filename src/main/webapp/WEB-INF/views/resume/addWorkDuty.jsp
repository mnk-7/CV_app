...
<section id="about" class="about section-show">
    ...
    <form name="addWorkDuty" method="post" action='<c:url value="/resume/${person.personId}/edit/work/${workExperience.workId}/edit/duty/add"/>'>
        ...
        <div class="content" data-aos="fade-left">
            ...
            <div class="row">
                <ul>
                    <div class="row">
                        <div class="col-lg-7">
                            <textarea class="form-ctrl-margin" name="description" id="description" rows="1" placeholder="Describe your duties"></textarea>
                        </div>
                        <div class="col-sm-4 col-md- col-lg- col-xl- d-flex align-items-center">
