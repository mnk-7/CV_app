...
<section id="about" class="about section-show">
    ...
    <form name="addTechSkill" method="post" action='<c:url value="/skills/${person.personId}/edit/tech/add"/>'>
        ...
        <div class="content" data-aos="fade-left">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="name" id="techSkillName" placeholder="Enter technology name">
                </div>
            </div><br>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="percentage" id="percentage" placeholder="Estimate your level">
                </div>
            </div>
