...
<section id="about" class="about section-show">
    ...
    <form name="addLangSkill" method="post" action='<c:url value="/skills/${person.personId}/edit/lang/add"/>'>
        ...
        <div class="content" data-aos="fade-left">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <input class="form-ctrl" type="text" name="name" id="langSkillName" placeholder="Enter language">
                </div>
            </div><br>
